            ...
            function(require, module, exports) {
                (function(global) {
                    ...
                    (function browserifyShim(
                        ...
                        browserify_shim__define__module__export__(
                            typeof Stats != 'undefined' ? Stats : window.Stats
                        );
                    }.call(
                        global,
                        undefined,
        ...
        2: [
            function(require, module, exports) {
                ...
                function createScene() {
                    ...
                    var refractionCube = new THREE.Texture(
                    ...
                    var colors = [0x9e735f, 0xffffff, 0x5babc2];
                    var count = 5;
                ...
                function createRenderTarget(renderer, width, height) {
                    ...
                    var maxRenderTargetSize = gl.getParameter(
                ...
                function setupPostProcessing(renderer, width, height) {
                    ...
                    var lookupTexture = THREE.ImageUtils.loadTexture(
                        'img/lookup_film.png'
                    );
                ...
                domready(function() {
                    ...
                    function updateLabels() {
                        document.querySelector('.post').style.display = usePost
                            ? 'block'
                            : 'none';
                        document.querySelector(
                            '.fxaa-on'
                        ).style.display = !useFXAA ? 'block' : 'none';
                        document.querySelector(
                            '.fxaa-off'
                        ).style.display = useFXAA ? 'block' : 'none';
                    }
                    ...
                    function render() {
                        ...
                        if (usePost) {
                            ...
                            renderer.render(
                                scene,
                                camera,
                                useFXAA ? post.target : post.target2
                            );
            ...
            function(require, module, exports) {
                ...
                module.exports = require('glslify/simple-adapter.js')(
                    ...
                    [
                        ...
                        { name: 'grainamount', type: 'float' },
                        { name: 'colored', type: 'bool' },
                        { name: 'coloramount', type: 'float' },
                        { name: 'grainsize', type: 'float' },
                        { name: 'lumamount', type: 'float' },
                        { name: 'filterStrength', type: 'float' },
                        { name: 'resolution', type: 'vec2' },
                        { name: 'texture', type: 'sampler2D' },
                        { name: 'k', type: 'float' },
                        { name: 'kcube', type: 'float' },
                        { name: 'scale', type: 'float' },
                        { name: 'dispersion', type: 'float' },
                        { name: 'blurAmount', type: 'float' },
                        { name: 'blurEnabled', type: 'bool' },
                        { name: 'scratches', type: 'float' },
                        { name: 'burn', type: 'float' },
                        { name: 'lookupTexture', type: 'sampler2D' }
                    ],
                    []
                );
            },
            { glslify: 7, 'glslify/simple-adapter.js': 8 }
        ],
        6: [
            function(require, module, exports) {
                /*!
